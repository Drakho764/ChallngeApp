...
import 'package:appmotos/models/data.dart';
import 'package:appmotos/pages/details_motos.dart';
import 'package:appmotos/widgets/widget_app_bar.dart';
import 'package:appmotos/widgets/widget_footer_bar.dart';

class HomeMotos extends StatefulWidget {
  //Constructor
  const HomeMotos({Key? key}) : super(key: key);

  @override
  State<HomeMotos> createState() => _HomeMotosState();
}

class _HomeMotosState extends State<HomeMotos> {
        ...
        children: [
          ...
          Expanded(
            ...
            itemBuilder: ((context, index) {
              ...
              final listTitle = motos.category.split('');
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    PageRouteBuilder(
                      pageBuilder: (context, animation, _) {
                        return DetailsMotos(motos: motos);
                      },
                    ),
                  );
                },
                    ...
                    child: LayoutBuilder(builder: (context, constraints) {
                      return AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Color.fromARGB(255, 222, 241, 245),
                        ),
                        child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Image.asset(iconsCompany[index],
                                            width: 30, height: 30),
                                      ],
                                    )
